...
<template>
    ...
    >
        ...
        >
            ...
            >
                <div
                    class="btn btn-icon btn-color-white btn-active-color-primary w-35px h-35px"
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <div
                            v-if="
                                oUser.permisos.includes('configuracions.index')
                            "
                            data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                            data-kt-menu-placement="bottom-start"
                            data-kt-menu-offset="-50,0"
                        ...
                        <div
                            v-if="
                                oUser.permisos.includes('parametrizacions.index')
                            "
                            data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                            data-kt-menu-placement="bottom-start"
                            data-kt-menu-offset="-50,0"
                ...
                <div class="app-navbar flex-shrink-0">
                    ...
                    <div class="app-navbar-item">
                        <button
                            class="btn btn-sm btn-secondary d-flex flex-center ms-6 ps-3 pe-4 h-35px"
