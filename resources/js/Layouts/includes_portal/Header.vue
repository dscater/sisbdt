...
<template>
    ...
    <div class="mb-0" id="home">
        ...
        <div
            ...
            :style="{
                'background-image': `url(${url_assets}/assets/template/media/svg/illustrations/landing.svg)`,
            }"
        >
            <!--begin::Header-->
            <div
                ...
                <div class="container">
                    ...
                    >
                        ...
                        <div class="d-flex align-items-center flex-equal">
                            ...
                            <a href="landing.html">
                                ...
                                <img
                                    ...
                                    :src="
                                        url_assets +
                                        '/assets/template/media/logos/landing-dark.svg'
                                    "
                        ...
                        <div class="flex-equal text-end ms-1" v-if="!user">
                            <Link :href="route('login')" class="btn btn-danger"
                                >Iniciar Sesión</Link
                            >
                        </div>
                        <div class="flex-equal text-end ms-1" v-if="user">
                            <Link :href="route('inicio')" class="btn btn-danger"
            ...
            >
                ...
                <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
                    ...
                    <!--end::Title-->
                    <!--begin::Action-->
                    <Link :href="route('register')" class="btn btn-lg btn-primary"
                        >Evaluate</Link>
                    <!--end::Action-->
                </div>
                <!--end::Heading-->
