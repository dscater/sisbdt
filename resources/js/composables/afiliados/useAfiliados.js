...
export const useAfiliados = () => {
    ...
    const getUsuarios = async () => {
        try {
            const response = await axios.get(route("afiliados.listado"), {
    ...
    const getUsuariosByTipo = async (data) => {
        try {
            const response = await axios.get(route("afiliados.byTipo"), {
                headers: { Accept: "application/json" },
                params: data,
            });
            return response.data.usuarios;
    ...
    const saveUsuario = async (data) => {
        try {
            const response = await axios.post(route("afiliados.store", data), {
                headers: { Accept: "application/json" },
            });
            Swal.fire({
                icon: "success",
